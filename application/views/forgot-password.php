...
<body class="hold-transition login-page" style="height:0;background-repeat: no-repeat;background: url('<?= base_url('uploads/bg/pos_bg2.jpg') ?>') no-repeat center center fixed">
  <?php 
  //Find Logo Path
