...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section class="invoice" style="border:2px solid red;">
      <!-- title row -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <?php  if($approved_request == 2){  ?>

              <span href="#" class="label label-danger" >
                  <i class="fa  fa-time"></i> Rejected
              </span>
       ...
       <div class="col-md-6">
          ...
          <!-- gift table-->
           ...
           $gift = $this->db->query("SELECT  a.item_id, a.sales_qty,c.item_name
                                  FROM 
                                  tmp_giftitems AS a,db_items AS c 
                                  WHERE 
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <?php  if($approved_request == 3 && ($CI->permissions('sales_approved_panel_action')) ){  ?>

              <a href="#" class="btn btn-success" id="approved">
                  <i class="fa  fa-check"></i> Approved
              </a>

              <a href="" class="btn btn-danger" id="rejected">
         ...
         <?php if(isset($sales_id)){ ?> 
             $(document).ready(function(){
                 ...
                 $('#approved').click(function (e) {
                  ...
                  $("#approved").attr('disabled',false);  //Enable Save or Update button
                    $(".overlay").remove();
                  }); 
                 ...
                 $('#rejected').click(function (e) {
                  ...
                  $("#rejected").attr('disabled',false);  //Enable Save or Update button
                    $(".overlay").remove();
                  }); 
